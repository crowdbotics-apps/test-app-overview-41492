"""
Django settings for test_app_overview_41492 project.
...
ROOT_URLCONF = 'test_app_overview_41492.urls'
...
WSGI_APPLICATION = 'test_app_overview_41492.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_app_overview_41492 API",
    "DESCRIPTION": "API documentation for test_app_overview_41492 App",
    "VERSION": "v1",
}
